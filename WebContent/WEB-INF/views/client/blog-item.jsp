     ...
     <section id="blog" class="container">
        ...
        <div class="blog">
            <div class="row">
                <div class="col-md-8">
                    <div class="blog-item">
                        <img class="img-responsive img-blog" src="${pageContext.request.contextPath}/resources/images/blog/blog1.jpg" width="100%" alt="" />
                            <div class="row">  
                                <div class="col-xs-12 col-sm-2 text-center">
                                    <div class="entry-meta">
                                        <span id="publish_date">07  NOV</span>
                                        <span><i class="fa fa-user"></i> <a href="#"> John Doe</a></span>
                                        <span><i class="fa fa-comment"></i> <a href="blog-item.do#comments">2 Comments</a></span>
                        ...
                        <div class="media reply_section">
                            <div class="pull-left post_reply text-center">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/images/blog/boy.png" class="img-circle" alt="" /></a>
                                <ul>
                        ...
                        <div class="media comment_section">
                            <div class="pull-left post_comments">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/images/blog/girl.png" class="img-circle" alt="" /></a>
                            </div>
                        ...
                        <div class="media comment_section">
                            <div class="pull-left post_comments">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/images/blog/boy2.png" class="img-circle" alt="" /></a>
                            </div>
                            <div class="media-body post_reply_comments">
                                <h3>Marsh</h3>
                                <h4>NOVEMBER 9, 2013 AT 9:15 PM</h4>
                        ...
                        <div class="media comment_section">
                            <div class="pull-left post_comments">
                                <a href="#"><img src="${pageContext.request.contextPath}/resources/images/blog/boy3.png" class="img-circle" alt="" /></a>
                            </div>
                            <div class="media-body post_reply_comments">
                                <h3>Marsh</h3>
                                <h4>NOVEMBER 9, 2013 AT 9:15 PM</h4>
